 ...
 * // $user_in_coord is now available as a boolean
...
// Define global constant for coordinator status (for use in included files)
...
if (!empty($GLOBALS['global_username'] ?? '')) {
    // FIX: Use $u_name consistently (was $username in one place)
    ...
    <header class="mb-3 border-bottom">
            ...
            <div class="container-fluid" id="navbardiv">
                ...
                <div class="collapse navbar-collapse" id="collapsibleNavbar">
                    <ul class="navbar-nav flex-row flex-wrap bd-navbar-nav">
                        ...
                        <li class="nav-item col-lg-auto col-md-4 col-sm-6 col-6" id="coord">{$coord_tools}</li>
        ...
        <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="logoutModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h6 class="modal-title" id="logoutModalLabel">Ready to Leave?</h6>
                        <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                    </div>
                    <div class="modal-body">Select &quot;Logout&quot; below if you are ready to end your current session.</div>
                    <div class="modal-footer">
