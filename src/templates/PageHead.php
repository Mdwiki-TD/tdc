...
class PageHead
{
    ...
    private array $scriptsModule;

    public function __construct()
    {
        $this->hoste = (getenv('APP_ENV') === 'production')
    ...
    /**
     * Builds the <link>/<script> tags for all stylesheets and scripts.
     */
    private function head(): string
    {
        ...
        foreach ($this->scriptsModule as $js) {
     ...
     */
    public function print_full_head(): string
    {
        $headText = isset($_GET["noboot"]) ? "" : $this->head();
    ...
    /**
     * Returns 'active' if the given file name matches the current script.
     */
    public function is_active(string $url): string
    {
    ...
    /**
     * Renders the <header>/<nav> markup, including the logout modal.
     */
    public function write_body(string $coordTools, string $liUser): string
    {
        return <<<HTML
                    ...
                    <div class="container-fluid" id="navbardiv">
                        ...
                        <div class="collapse navbar-collapse" id="collapsibleNavbar">
                            <ul class="navbar-nav flex-row flex-wrap bd-navbar-nav">
                                <li class="nav-item col-lg-auto col-md-4 col-sm-6 col-6" id="leaderboard">
                                ...
                                <li class="nav-item col-lg-auto col-md-4 col-sm-6 col-6" id="missing">
