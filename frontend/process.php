...
<head>
    ...
    <title>Wiki Project Med Translation Dashboard - In Process</title>
...
<body>
    ...
    <main id="body">
        <div id="maindiv" class="container-fluid">
            <div class="card">
                ...
                <div class='card-body'>
                    <table class="table table-sm table-striped" id="process-table">
                        <thead>
                            <tr>
                                <th>#</th>
                                <th>User</th>
    ...
    <script>
        $(document).ready(function() {
            fetch('/backend/router.php?action=process')
                    ...
                    if (data.success) {
                        ...
                        data.data.forEach(item => {
                            const row = `
                                <tr>
                                    <td>${counter++}</td>
                                    <td><a href="/Translation_Dashboard/leaderboard.php?user=${item.user}">${item.user}</a></td>
                                    <td><a href="/Translation_Dashboard/leaderboard.php?langcode=${item.lang}">${item.lang}</a></td>
                        ...
                        console.error('Failed to fetch in-process translations:', data.message);
                    }
                })
                .catch(error => {
